...
class PDFReport(FPDF):
    ...
    def configure_fonts(self):
        base = "static/fonts/Noto_Sans"
        self.add_font("Sans", style="", fname=f"{base}/NotoSans-Regular.ttf")
        self.add_font("Sans", style="B", fname=f"{base}/NotoSans-Bold.ttf")
        self.add_font("Sans", style="I", fname=f"{base}/NotoSans-Italic.ttf")
        self.add_font("Sans", style="BI", fname=f"{base}/NotoSans-BoldItalic.ttf")
